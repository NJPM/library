...
*/    }, function(err, results) {
        ...
        // Successful, so render.
        res.render('bookinstance_delete', { title: 'Delete BookInstance', bookinstance: results.bookinstance, /*author_books: results.authors_books*/ } );
    });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel(function(err, results) {
                ...
                res.render('bookinstance_form', { title: 'Update Book Instance',bookinstance:results.bookinstance, errors: errors.array() });
            });
            return;
        }
        else {
